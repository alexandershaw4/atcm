function [Ep,qC,qh,F] = asample(M,U,Y)
...
%==========================================================================
Gmax  = -Inf;
for k = 1:(64) % alex: bump from 64 to 512
    ...
    for i = 1:ngibbs
        ...
        % alex: sample from a continuous uniform distribution 
        %RNG = unifrnd(-1 , 1 , [np 1]);
        
        %P(:,i) = qE + qS*RNG; %randn(np,1);
