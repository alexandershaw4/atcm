...
for i = 1:ns
        ...
        if ~IncludeMH
          ...
          f(i,:,1) =         (GL*(x(i,:,1)-VL)-...
                       x(i,:,2) .* m_infty(V0) .*(w_infty(x(i,:,1))-VE)-...
                       x(i,:,3) .* m_infty(V0) .*(w_infty(x(i,:,1))-VI)-...
                       x(i,:,5) .* m_infty(V0) .*(w_infty(x(i,:,1))-VB)-...
                       x(i,:,4) .* m_infty(V0) .*(w_infty(x(i,:,1))-VN).*mg_switch(x(i,:,1)))./CV;
