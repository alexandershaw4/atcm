function [f,J,Q,D,IntrCon,rate] = tcm(x,u,P,M)
...
GEa(1,:) = [0   0   0   0   0   2   0   4]/10;
GEa(2,:) = [4   0   0   0   0   0   0   0]/10;
GEa(3,:) = [4   4   0   0   0   0   0   0]/10;
GEa(4,:) = [0   4   0   0   0   0   0   0]/10;
GEa(5,:) = [0   0   0   4   0   0   0   0]/10;
GEa(6,:) = [0   0   0   2   0   0   0   0]/10;
GEa(7,:) = [0   0   0   0   0   0   0   2]/10;
GEa(8,:) = [0   0   0   0   0   2   0   0]/10;

% This is the Traub et al 2004 TC model excitatory connectivity pattern
%           ss  sp  si  dp  di  tp  rt  rl   
GEa(1,:) = [0   4   0   4   0   0   0   2]/10; % ss
GEa(2,:) = [2   0   0   4   0   4   0   2]/10; % sp
GEa(3,:) = [2   4   0   4   0   0   0   2]/10; % si
GEa(4,:) = [2   4   0   0   0   0   0   2]/10; % dp
GEa(5,:) = [2   4   0   4   0   0   0   2]/10; % di
GEa(6,:) = [0   4   0   4   0   0   0   2]/10; % tp
GEa(7,:) = [0   0   0   0   0   4   0   0]/10; % rt
GEa(8,:) = [0   0   0   0   0   4   0   0]/10; % rl
...
%--------------------------------------------------------------------------
CV   = exp(P.CV).*[128 32 32 128 64 128 256 128]/1000;  
CV   = exp(P.CV).*[128 32 32 128 64 128 256 128]/1000;  
