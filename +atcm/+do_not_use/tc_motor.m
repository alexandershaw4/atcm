function [f,J,Q,D,DV] = tc_motor(x,u,P,M,m)
...
%           mp  sp  si  dp  di  tp  rt  rl   
GEa(1,:) = [0   1   0   0   0   4   0   4]/1;
GEa(2,:) = [4   0   0   1   0   0   0   0]/1;
GEa(3,:) = [4   4   0   0   0   0   0   0]/1; 
GEa(4,:) = [0   4   0   0   0   0   0   0]/1;
GEa(5,:) = [0   0   0   4   0   0   0   0]/1;
GEa(6,:) = [0   0   0   4   0   0   0   0]/1;
...
%CV   = exp(P.CV).*      [128 32  32  128 64  128  256 64*4]/1000;  
...
%         end
        ...
        DV       = 1./[1 1 1 1 1 1 1 1];  % CHANGED SEPT2019
...
%--------------------------------------------------------------------------
Tc              = zeros(np,np);
Tc([7 8],[1:6]) = 8  * exp(P.D0(1)); % L6->thal
Tc([1:6],[7 8]) = 3  * exp(P.D0(2)); % thal->ss
