function [f,J,Q,D,DV] = tcm_nomh_delays_spiking(x,u,P,M,m)
...
%         % remove thalamic states if not in use:
%         if ~HasThal
%             f(i,[7 8],:) = 0;
%         end
