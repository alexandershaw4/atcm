function [f,J,Q] = spm_fx_cortical6(x,u,P,M,ith)
% state equations for canonical 6 pop neural mass
%
...
CV   = exp(P.CV).*[128 128 256 32 256 32]/1000;  % membrane capacitance
