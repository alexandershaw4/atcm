function [f,J,Q] = tc_dev_dev3(x,u,P,M,m)
...
GEa(2,:) = [24  0   0   0   0   0   0   1]/1;
GEa(3,:) = [4   8   0   0   0   0   0   0]/1; 
...
%--------------------------------------------------------------------------
%           ss  sp  si  dp  di  tp  rt  rl
GIa(1,:) = [2   0   2   0   0   0   0   0 ];
GIa(2,:) = [0   32  64  0   0   0   0   0 ];
GIa(3,:) = [0   0   32  0   8   0   0   0 ];
GIa(4,:) = [0   0   0   8   8   0   0   0 ];
GIa(5,:) = [0   0   32  0   8   0   0   0 ];
GIa(6,:) = [0   0   0   0   8   4   0   0 ];
GIa(7,:) = [0   0   0   0   0   0   4   0 ];
GIa(8,:) = [0   0   0   0   0   0   4   4]; % 32!! SEPT
